...
import com.github.jochenw.icm.isclient.util.DefaultValuesWriter;
import com.github.jochenw.icm.isclient.util.Exceptions;
import com.github.jochenw.icm.isclient.util.ValuesReader;
import com.github.jochenw.icm.isclient.util.ValuesWriter;

public class IcmIsClient implements ServiceInvoker {
	...
	public IcmIsClient(String pHostName, int pPort, boolean pUsingSsl, String pUserName, String pPassword) {
		this(new HttpUrlConnector(), pHostName, pPort, pUsingSsl, pUserName, pPassword);
	}

	public IcmIsClient(URL pUrl, String pUserName, String pPassword) {
		this(new HttpUrlConnector(), pUrl, pUserName, pPassword);
	}

	public IcmIsClient(HttpUrlConnector pConnector, String pHostName, int pPort, boolean pUsingSsl, String pUserName, String pPassword) {
	...
	public IcmIsClient(HttpUrlConnector pConnector, URL pUrl, String pUserName, String pPassword) {
		connector = pConnector;
