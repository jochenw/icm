...
public class Tests {
	...
	private static IcmIsClient client;

	public static Properties getTestProperties() {
		if (props == null) {
			URL url = Tests.class.getResource("/icm-isclient-test.properties");
	...
	public static IcmIsClient newIcmIsClient() throws MalformedURLException {
		if (client == null) {
			...
			if (url == null  ||  url.length() == 0  ||  "${wmis.remote.url}".equals(url)) {
				...
				client = new IcmIsClient(u, userName, password);
			}
		}
		return client;
	}
